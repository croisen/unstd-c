...
void build(Nobita_Build *b) {
  ...
  Nobita_Target_Add_Sources(lc, "src/syscall/syscalls.c", NULL);
  Nobita_Target_Add_Headers(lc, "include", "syscall.h", NULL);
  ...
  Nobita_Target_Add_Cflags(crt, "-nostdinc", "-nostdlib", "-g", NULL);
  ...
  Nobita_Target_Add_Cflags(hello, "-nostdinc", "-nostdlib", "-g", NULL);
