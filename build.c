...
void build(Nobita_Build *b) {
  ...
  Nobita_Target_Add_Cflags(lc, "-nostdlib", "-g", "-fPIC", "-O3", NULL);
  Nobita_Target_Add_Sources(lc, "src/*/*.c", "src/*/*/*.c", NULL);
  Nobita_Target_Add_Headers(lc, "include", "errno.h", "stdarg.h", "stddef.h",
                            "stdlib.h", "syscall.h", "unistd.h", NULL);
  ...
  Nobita_Target_Add_Cflags(crt, "-nostdlib", "-g", "-O3", NULL);
  ...
  Nobita_Target_Add_Cflags(hello, "-nostdlib", "-g", "-O3", NULL);
  Nobita_Target_Add_Sources(hello, "test/hello.c", NULL);
  Nobita_Target_Add_LDflags(hello, "-lc", NULL);
  Nobita_Target_Add_Fmt_Arg(hello, NOBITA_T_LDFLAGS, "-Wl,-rpath,%s",
                            Nobita_GetLib(b));
